...
interface ScoreStorage {
	 ...
	 * @param callable $errorCallback This callback is called when we cannot parse a revision score
	 *        response. The signature is errorCallback( string $errorMessage, string $revisionID )
	 */
