 ...
 * @covers ORES\StatsV1
 */
class StatsV1Test extends \MediaWikiTestCase {
	...
	public function testGetThresholds_modelConfigNotFound() {
		$api = $this->getMockBuilder( ApiV1::class )->getMock();
		$logger = $this->getLoggerMock();
		$stats = new ORES\StatsV1( $api, WANObjectCache::newEmpty(), $logger );
